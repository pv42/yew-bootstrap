...
pub fn include_cdn_js() -> VNode {
    html! {
        <>
            <link data-trunk={"true"} rel="copy-file" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js.map" />
            <script
...
pub fn include_inline() -> VNode {
    html! {
        <style>
            {include_str!("bootstrap-5.3.2.min.css")}
        </style>
    }
}
